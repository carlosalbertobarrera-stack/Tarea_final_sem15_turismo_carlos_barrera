...
-- Crear el schema public (por defecto en PostgreSQL, pero se
-- declara explícitamente para garantizar ownership y permisos)
CREATE SCHEMA IF NOT EXISTS public;

-- Descripción del schema
COMMENT ON SCHEMA public IS 'Schema principal de la base de datos accommodations_tourism. Contiene todas las tablas, secuencias, funciones, índices y triggers del sistema de gestión de alojamientos turísticos.';

-- Permisos estándar del schema public
-- (necesarios para que los usuarios puedan crear objetos y acceder)
